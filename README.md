# YOLOV10 🔥
Bu projede YOLOV10 hakkında bilgi vereceğim ve kurarken aldığım hataları yazacağım. Öncelikle YOLOV10 modeli henüz çıkmadı. Bu [https://github.com/THU-MIG/yolov10](url) sayfadan demo modunu kullanabiliyoruz. Ultralytics in şuan en güncel modeli aslında V8 modelidir. Ancak aşağıdaki grafikler de modellerin bir karşılaştırılması yapılmıştır ve en iyi model olacağını görebiliyoruz. Bu projeyi ayrıca REAL TIME OBJECT DETECTION olarak kullanabilirsiniz. YOLO ile ilgili içerikler devam edicek...
